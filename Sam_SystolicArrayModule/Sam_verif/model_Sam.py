...
@counter_coverage
def model_Sam(EN_read_A: int,read_A_a_in: int, EN_read_B: int,read_B_b_in: int, EN_read_C: int,read_C_c_in: int, EN_read_S: int,read_S_s_in: int,EN_mac_calc: int) -> int:
